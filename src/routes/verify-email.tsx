  ...
  async function refresh() {
    ...
    try {
      ...
      if (u && (u.email_confirmed_at || u.confirmed_at)) {
        ...
        toast.info("Not verified yet. Please click the confirmation link in your email.");
      }
    } catch (err) {
        ...
        <Card className="p-6 bg-gradient-surface border-border shadow-card text-center space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <span className="text-foreground font-medium">{email || "your inbox"}</span>. Click the link in that
              email to activate your account — this page updates automatically once you do.
            </p>
          </div>
