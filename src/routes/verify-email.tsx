        ...
        <Card className="p-6 bg-gradient-surface border-border shadow-card text-center space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              You can't access your dashboard until you confirm your email.
              We sent a verification link to{" "}
              <span className="text-foreground font-medium">{email || "your inbox"}</span>.
              Open Gmail and tap <span className="text-foreground font-medium">Verify Email</span> to activate your account.
            </p>
          </div>
